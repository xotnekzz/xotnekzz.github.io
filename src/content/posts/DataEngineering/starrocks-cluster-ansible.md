...
이번에는 이 인프라 위에 [StarRocks의 압도적 퍼포먼스 경험기](/posts/DataEngineering/starrocks-performance-experience) 에서 다룬 Starrocks 클러스터를 구축해보겠습니다. Starrocks는 분산 OLAP 데이터베이스로 FE노드의 고가용성(HA) 구성 BE 노드의 등록과정이 필요합니다.
