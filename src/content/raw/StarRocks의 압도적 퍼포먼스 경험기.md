...
source: "https://tedi.tistory.com/37"
author:
  - "[[Tedi__]]"
published: 2025-12-05
created: 2026-05-12
description: "1. 들어가며현재 회사에서 MariaDB ColumnStore를 메인 OLAP 데이터베이스로 잘 사용해왔습니다. 하지만 어느 순간부터 원인 불명의 '데이터 뻥튀기기' 현상과 커뮤니티 버전이 더 이상 업데이트 되지 않아 안정적인 운영이 어렵다고 판단하여 데이터베이스 교체를 검토하였습니다.이에 대안으로 Starrocks를 도입했고, 결과는 기대 이상이었습니다. 약 1년 지난 지금 Starrocks는 압도적인 성능과 편의성을 통해 데이터 분석환경에 큰 도움이 되고 있습니다. 제가 직접 경험한 Starrocks 핵심 강점을 소개하고자 합니다. 2. Starrocks ?Starrocks는 대규모 데이터 분석을 위해 설계된 MPP(Massively Parallel Processing) 데이터 베이스 입니다. .."
tags:
  - "clippings"
---
### 1\. 들어가며
...
![](https://blog.kakaocdn.net/dna/bwt92M/dJMcafkMH4G/AAAAAAAAAAAAAAAAAAAAAKl0UEvPU8LqaMA01T6ZQJQrlGY07f-BdFTmPHPo-0JO/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1780239599&allow_ip=&allow_referer=&signature=WwuHYr39mxUzFK1WHnC04RsJFB4%3D)

\[출처\] https://docs.starrocks.io/assets/images/architecture\_choices-ddd6ad78779f16a6691ec53a1f86ef06.png
...
![](https://blog.kakaocdn.net/dna/r08os/dJMcah3Yc2T/AAAAAAAAAAAAAAAAAAAAAICv-wxrLcxA7DhZyXmcwcHZq8eyOFsgrgPS5EB7KaIz/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1780239599&allow_ip=&allow_referer=&signature=HAoXxwNR5e2SfoYvYMACYoh9ukA%3D)
