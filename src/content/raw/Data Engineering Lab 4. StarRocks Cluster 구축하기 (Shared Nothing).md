...
source: "https://tedi.tistory.com/57"
author:
  - "[[Tedi__]]"
published: 2025-12-27
created: 2026-05-12
description: "[Data Engineering Lab] #3. KRaft 모드로 Kafka Cluster 로컬에 구축하기안녕하세요 지난 포스팅(https://tedi.tistory.com/55)에 이어 Kafka Cluster를 로컬 제 맥북에 구축해보도록 하겠습니다. [Data Engineering Lab] #2. Docker Container에 고정 IP 할당하기보통 Docker를 쓸 때는 localhost:909tedi.tistory.com 지난 포스팅 Kafka Cluster 구축기 (https://tedi.tistory.com/56)에 이어 차세대 OLAP 엔진으로 부상하고 있는 StarRocks 클러스터를 구축해보겠습니다. 1. StarRocks Architecture 선정StarRocks는 Shared-D.."
tags:
  - "clippings"
---
[

\[Data Engineering Lab\] #3. KRaft 모드로 Kafka Cluster 로컬에 구축하기

안녕하세요 지난 포스팅(https://tedi.tistory.com/55)에 이어 Kafka Cluster를 로컬 제 맥북에 구축해보도록 하겠습니다. \[Data Engineering Lab\] #2. Docker Container에 고정 IP 할당하기보통 Docker를 쓸 때는 localhost:909

tedi.tistory.com

](https://tedi.tistory.com/56)

지난 포스팅 Kafka Cluster 구축기 ([https://tedi.tistory.com/56](https://tedi.tistory.com/56))에 이어 차세대 OLAP 엔진으로 부상하고 있는 **StarRocks** 클러스터를 구축해보겠습니다.

## 1\. StarRocks Architecture 선정

![](https://blog.kakaocdn.net/dna/UhCFo/dJMb99Sxxn0/AAAAAAAAAAAAAAAAAAAAAAzDhavUJ8Zigme4lacp8a0Kaefh3c5w4Te3MpSuVn3L/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1780239599&allow_ip=&allow_referer=&signature=IUkWcyb4%2F1PHL2Ql%2BLf%2BRyGRTQs%3D)
...
![](https://blog.kakaocdn.net/dna/cNKCAj/dJMcabW7GDH/AAAAAAAAAAAAAAAAAAAAADTHSxFPFeb260yBWfdZqTpce272n_M7VeEiSz8LV2ln/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1780239599&allow_ip=&allow_referer=&signature=%2FnLxm4ZGeBlgK%2FC8yc1%2FqOjjg7U%3D)
...
- **리더와 팔로워**: starrokcs-fe-0가 리더 역할을 수행하며 가장 먼저 기동됩니다. 나머지 fe-1, fe-2 노드는 /opt/starrocks/fe\_entrypoint.sh starrocks-fe-0 커맨드를 통해 클러스터에 Join 합니다.
...
**\- FE 등록:** BE노드는 기동시 /opt/starrocks/fe\_entrypoint.sh starrocks-fe-0 커맨드로 FE 리더노드에게 BE 노드를 등록 요청을 합니다. 별도의 SQL없이 자동으로 노드 확장이 가능합니다.
...
**\- 네트워크 우선순위:** **STARROCKS\_PRIORITY\_NETWORKS=10.100.0.0/24** 설정을 통해 컨테이너가 여러 네트워크에 물려있어도 반드시 우리 랩의 전용 망으로 통신하게끔 강제했습니다.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2 | starrocks-fe-2\_9010\_1766764824096 | starrocks-fe-2 | 9010 | 8030 | true | ... |
| 3 | starrocks-fe-1\_9010\_1766764824116 | starrocks-fe-1 | 9010 | 8030 | true | ... |
| 1 | starrocks-fe-0\_9010\_1766764815633 | starrocks-fe-0 | 9010 | 8030 | true | ... |
