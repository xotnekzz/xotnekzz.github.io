---
title: 데이터 플랫폼 파트 — 5대 문제 & 해결 전략
description: 인프라 안정성 트랙(SPOF 제거, AVX2 전환)과 메달리온 아키텍처 트랙(Bronze/Silver/Gold)으로 나뉜 데이터 플랫폼 개선 전략
date: 2026-04-10
tags:
  - Apache Doris
  - StarRocks
...
![현재 아키텍처](images/architecture_asis.svg)
...
![개선 아키텍처](images/architecture_tobe_9.svg)
...
![이관 로드맵](images/migration_roadmap.svg)
